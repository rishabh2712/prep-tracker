# A7 Design a schema-driven form/rendering engine for prompt and workflow configuration
...
## Problem Statement
Design a schema-driven form/rendering engine for prompt and workflow configuration. Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
