# C2 Build retrieval debug UI: query rewrite, retrieved chunks, score, rerank order
...
## Problem Statement
Build retrieval debug UI: query rewrite, retrieved chunks, score, rerank order. Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
