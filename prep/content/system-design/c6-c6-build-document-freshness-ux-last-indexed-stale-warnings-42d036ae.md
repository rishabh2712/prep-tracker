# C6 Build document freshness UX (last indexed, stale warnings)
...
## Problem Statement
Build document freshness UX (last indexed, stale warnings). Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
