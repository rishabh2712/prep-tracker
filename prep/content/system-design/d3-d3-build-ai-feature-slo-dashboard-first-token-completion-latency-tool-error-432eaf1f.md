# D3 Build AI feature SLO dashboard (first token, completion latency, tool error)
...
## Problem Statement
Build AI feature SLO dashboard (first token, completion latency, tool error). Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
