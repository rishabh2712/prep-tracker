# F2 Build accessibility-complete chat/tool UIs (SR flow, keyboard-only operation)
...
## Problem Statement
Build accessibility-complete chat/tool UIs (SR flow, keyboard-only operation). Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
