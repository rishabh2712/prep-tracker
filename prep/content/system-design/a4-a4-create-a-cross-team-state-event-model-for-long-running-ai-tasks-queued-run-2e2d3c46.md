# A4 Create a cross-team state/event model for long-running AI tasks (queued/running/partial/complete/failed)
...
## Problem Statement
Create a cross-team state/event model for long-running AI tasks (queued/running/partial/complete/failed). Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
