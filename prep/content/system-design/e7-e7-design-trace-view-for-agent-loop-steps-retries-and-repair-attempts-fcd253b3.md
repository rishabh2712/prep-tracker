# E7 Design trace view for agent loop steps, retries, and repair attempts
...
## Problem Statement
Design trace view for agent loop steps, retries, and repair attempts. Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
