# A9 Build governance checks: lint rules, architecture checks, perf and accessibility budgets
...
## Problem Statement
Build governance checks: lint rules, architecture checks, perf and accessibility budgets. Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
