# G5 Design onboarding path so teams can launch AI workflows in under two weeks
...
## Problem Statement
Design onboarding path so teams can launch AI workflows in under two weeks. Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
