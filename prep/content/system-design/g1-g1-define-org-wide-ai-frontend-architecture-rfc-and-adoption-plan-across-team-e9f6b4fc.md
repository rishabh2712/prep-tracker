# G1 Define org-wide AI frontend architecture RFC and adoption plan across teams
...
## Problem Statement
Define org-wide AI frontend architecture RFC and adoption plan across teams. Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
