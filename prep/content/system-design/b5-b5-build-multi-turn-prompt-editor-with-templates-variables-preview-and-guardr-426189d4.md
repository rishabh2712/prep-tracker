# B5 Build multi-turn prompt editor with templates, variables, preview, and guardrails
...
## Problem Statement
Build multi-turn prompt editor with templates, variables, preview, and guardrails. Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
