# D6 Design unified online/offline evaluation console
...
## Problem Statement
Design unified online/offline evaluation console. Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
