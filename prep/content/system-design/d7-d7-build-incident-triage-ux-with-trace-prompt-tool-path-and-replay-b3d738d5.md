# D7 Build incident triage UX with trace, prompt, tool path, and replay
...
## Problem Statement
Build incident triage UX with trace, prompt, tool path, and replay. Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
