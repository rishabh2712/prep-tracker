# C8 Build retrieval A/B panel comparing two retrieval configs on same query set
...
## Problem Statement
Build retrieval A/B panel comparing two retrieval configs on same query set. Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
