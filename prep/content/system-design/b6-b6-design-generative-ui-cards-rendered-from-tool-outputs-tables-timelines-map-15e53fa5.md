# B6 Design generative UI cards rendered from tool outputs (tables, timelines, maps, diffs)
...
## Problem Statement
Design generative UI cards rendered from tool outputs (tables, timelines, maps, diffs). Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
