# F7 Design privacy-safe telemetry controls with redaction and opt-out
...
## Problem Statement
Design privacy-safe telemetry controls with redaction and opt-out. Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
