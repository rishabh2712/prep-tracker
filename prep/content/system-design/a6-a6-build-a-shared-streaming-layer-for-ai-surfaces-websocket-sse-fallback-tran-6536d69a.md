# A6 Build a shared streaming layer for AI surfaces (WebSocket/SSE/fallback transport)
...
## Problem Statement
Build a shared streaming layer for AI surfaces (WebSocket/SSE/fallback transport). Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
