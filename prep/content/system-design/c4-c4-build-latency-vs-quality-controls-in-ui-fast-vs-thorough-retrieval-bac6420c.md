# C4 Build latency-vs-quality controls in UI (fast vs thorough retrieval)
...
## Problem Statement
Build latency-vs-quality controls in UI (fast vs thorough retrieval). Scope this as if you are defining a reusable architecture pattern that multiple product teams can adopt within 1-2 quarters.
